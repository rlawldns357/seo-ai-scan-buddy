...
export const blogPosts: BlogPost[] = [
  {
    slug: "what-is-aeo",
    title: "AEO란? AEO 최적화로 ChatGPT 검색 노출시키는 방법 (2026)",
    excerpt:
      "AEO란 무엇인가? ChatGPT·Perplexity·뤼튼 같은 AI 답변 엔진이 내 콘텐츠를 인용하도록 만드는 AEO 최적화의 정의·방법·체크리스트를 서치튠OS(SearchTune OS) 기준으로 정리했습니다.",
    category: "AEO",
    author: "서치튠 블로거",
    date: "2026-04-01",
...
**AEO란** Answer Engine Optimization(답변 엔진 최적화)의 약자로, ChatGPT·Perplexity·뤼튼 같은 AI 답변 엔진이 사용자 질문에 답할 때 **내 콘텐츠를 출처로 인용**하도록 만드는 최적화 전략입니다. ChatGPT 검색 노출, Perplexity 인용, 네이버 AI 브리핑 노출이 모두 AEO의 영역입니다.

기존 SEO가 검색 결과 페이지(SERP) 상위 노출을 목표로 한다면, **AEO 최적화**는 AI가 생성하는 답변 안에 내 콘텐츠가 직접 포함되는 것을 목표로 합니다. 서치튠OS(SearchTune OS)는 SEO·AEO·GEO를 하나의 진단으로 평가합니다.
...
- [SEO AEO GEO 차이: 검색·답변·생성형 최적화 통합 전략](/blog/seo-vs-aeo-vs-geo)
...
> AEO는 선택이 아닌 필수입니다. AI 검색 시대에 대비하여 지금부터 콘텐츠를 최적화하세요.`,
  },
  {
    ...
    title: "GEO 최적화 완전 가이드 — 생성형 검색 최적화·AI 검색 최적화 (2026)",
    excerpt:
      "GEO 최적화란? Google SGE·Naver Cue:·Bing Copilot 등 생성형 AI 검색에서 브랜드와 콘텐츠가 출처로 인용되도록 만드는 생성형 검색 최적화·AI 검색 최적화 전략을 SearchTuneOS 기준으로 정리합니다.",
    category: "GEO",
    author: "서치튠 블로거",
    date: "2026-03-28",
    thumbnail: "/placeholder.svg",
...
관련: [AEO란 무엇인가](/blog/what-is-aeo) · [SEO·AEO·GEO 차이](/blog/seo-vs-aeo-vs-geo) · [AI 크롤러 허용 설정법](/blog/ai-crawler-access) · [구조화 데이터 가이드](/blog/structured-data-guide)
...
SearchTune OS의 SEO 분석에서는 구조화 데이터의 존재 여부, 유효성, 그리고 개선 기회를 자동으로 진단합니다.`,
  },
  {
    ...
    title: "SEO AEO GEO 차이 한 번에 정리 — AEO와 SEO의 차이점·GEO SEO 차이",
    excerpt:
      "SEO AEO GEO 차이가 헷갈린다면 이 글 하나로 끝내세요. AEO와 SEO의 차이점, GEO SEO 차이, 그리고 세 가지를 어떤 순서로 최적화해야 하는지 서치튠 기준으로 정리했습니다.",
    category: "가이드",
    author: "서치튠 블로거",
    date: "2026-06-05",
    thumbnail: "/placeholder.svg",
...
**SEO AEO GEO 차이**는 "어떤 검색 환경에서 노출되느냐"의 차이입니다. **AEO와 SEO의 차이점**은 SEO가 검색 결과 SERP 상위 노출을 노린다면 AEO는 AI 답변 안의 인용을 노린다는 점이고, **GEO SEO 차이**는 GEO가 Google SGE·Naver Cue: 같은 생성형 검색에서 브랜드 추천을 노린다는 점입니다. 서치튠OS는 이 세 점수를 한 번의 진단으로 보여줍니다.
...
- [AEO란 무엇인가 · AEO 최적화 가이드](/blog/what-is-aeo)
- [GEO 최적화 · 생성형 검색 최적화 완전 가이드](/blog/generative-engine-optimization)
- [FAQ 스키마 작성 방법 · 구조화 데이터 FAQPage](/blog/faq-schema-aeo-boost)
- [robots.txt AI 크롤러 허용 설정법](/blog/ai-crawler-access)`,
  },
  {
    slug: "faq-schema-aeo-boost",
    title: "FAQ 스키마 작성 방법 — FAQPage 구조화 데이터로 AEO 점수 올리기",
    excerpt:
      "FAQ 스키마 작성 방법을 단계별로 정리했습니다. 구조화 데이터 FAQPage(JSON-LD)를 적용해 FAQ 스키마 AEO 점수를 끌어올리는 5가지 실전 룰을 SearchTune OS 기준으로 공개합니다.",
    category: "AEO",
    author: "서치튠 블로거",
    date: "2026-06-05",
    thumbnail: "/placeholder.svg",
    ...
    content: `> **TL;DR** — FAQPage JSON-LD를 본문 하단에 1개만 넣고, 질문 5~10개·답변 2~3문장 규칙을 지키면 AEO 인용 확률이 가장 빠르게 올라갑니다. 답변이 페이지에 실제로 보여야 한다는 [Google FAQ 구조화 데이터 가이드](https://developers.google.com/search/docs/appearance/structured-data/faqpage) 규칙은 반드시 지키세요.

관련: [AEO란 무엇인가](/blog/what-is-aeo) · [구조화 데이터 가이드](/blog/structured-data-guide) · [SEO·AEO·GEO 차이](/blog/seo-vs-aeo-vs-geo)

## FAQ 스키마 작성 방법 — 왜 AEO에 결정적인가

**FAQ 스키마 작성 방법**은 AEO 최적화에서 가장 효율 높은 작업입니다. **구조화 데이터 FAQPage**([Schema.org FAQPage](https://schema.org/FAQPage) JSON-LD)를 적용하면 ChatGPT·Perplexity·Naver Cue: 같은 AI 답변 엔진이 질문-답변 쌍을 그대로 파싱해 출처로 인용할 확률이 크게 높아집니다. **FAQ 스키마 AEO** 효과는 추가 콘텐츠 작성 없이 즉시 측정 가능합니다.
...
SearchTune OS에서 FAQ 스키마의 유효성과 AEO 기여도를 즉시 확인할 수 있습니다.`,
  },
  {
    ...
    title: "robots.txt AI 크롤러 허용 설정법 — GPTBot·Google-Extended·ClaudeBot",
    excerpt:
      "robots.txt에서 AI 크롤러 허용을 어떻게 설정하나요? GPTBot·Google-Extended·ClaudeBot·PerplexityBot·Yeti 등 주요 AI 크롤러 접근 제어 방법과 GEO 점수에 미치는 영향을 SearchTuneOS 기준으로 정리합니다.",
    category: "GEO",
    author: "서치튠 블로거",
    date: "2026-06-05",
    thumbnail: "/placeholder.svg",
...
관련: [AEO란 무엇인가](/blog/what-is-aeo) · [SEO·AEO·GEO 차이](/blog/seo-vs-aeo-vs-geo) · [GEO 최적화 완전 가이드](/blog/geo-generative-engine-optimization)
...
SearchTune OS는 이 세 가지 축을 한 번에 분석하여 종합적인 검색 최적화 전략을 수립할 수 있도록 돕습니다.`,
  },
  {
    ...
    title: "네이버 서치어드바이저 완벽 가이드 — 네이버 색인 요청·사이트맵 제출 방법",
    excerpt:
      "네이버 서치어드바이저 등록부터 네이버 색인 요청, 네이버 사이트맵 제출 방법, IndexNow까지 한 번에 정리했습니다. 네이버 SEO 진단을 시작하기 전에 반드시 거쳐야 할 단계를 SearchTune OS 기준으로 안내합니다.",
    category: "SEO",
    author: "서치튠 블로거",
    date: "2026-06-05",
    thumbnail: "/placeholder.svg",
    ...
    content: `> **TL;DR** — 한국 검색 시장의 약 50%를 차지하는 네이버에서 노출되려면 **네이버 서치어드바이저 등록 → 사이트맵 제출 → IndexNow 연동** 3단계가 필수입니다. 등록 안 하면 네이버 색인 자체가 시작되지 않습니다.

관련: [네이버 SEO 최적화 핵심 팁](/blog/naver-seo-optimization-tips) · [Naver Cue: GEO 전략](/blog/naver-cue-geo-strategy) · [robots.txt AI 크롤러 허용](/blog/ai-crawler-access)

## 네이버 서치어드바이저란?

**네이버 서치어드바이저**(Naver Search Advisor)는 네이버 검색에 사이트를 등록하고 **네이버 색인 요청**·**네이버 사이트맵 제출**·노출 현황을 관리하는 공식 웹마스터 도구입니다. Google Search Console의 네이버 버전으로 이해하면 됩니다. 한국 시장을 노리는 모든 사이트는 **네이버 SEO 진단**의 첫 단계로 서치어드바이저 등록이 필수입니다.
...
> SearchTune OS의 GEO 분석으로 Google과 Naver AI 검색 모두에 대한 준비도를 확인하세요.`,
  },
  {
    ...
    title: "아임웹 SEO 완벽 가이드 — 아임웹 SEO 한계와 아임웹 검색 노출 극복법",
    excerpt:
      "아임웹 SEO는 어디까지 가능할까? 아임웹 SEO 한계(HTML 제어·SSR·구조화 데이터)와 아임웹 검색 노출을 끌어올리는 실전 최적화 전략을 서치튠OS(SearchTune OS) 기준으로 단계별 정리했습니다.",
    category: "가이드",
    author: "서치튠 블로거",
    date: "2026-06-05",
    thumbnail: "/placeholder.svg",
    ...
    content: `> **TL;DR** — **아임웹 SEO 한계**(HTML 직접 수정 불가·SSR 미지원)는 '머리글 코드 삽입'으로 JSON-LD를 우회 주입하고, 메타 태그·ALT·페이지별 description을 100% 채우는 것으로 70%까지 보완할 수 있습니다. 나머지 30%는 콘텐츠 품질로 메웁니다.

관련: [카페24 SEO 완벽 가이드](/blog/cafe24-seo-guide) · [FAQ 스키마 작성 방법](/blog/faq-schema-aeo-boost) · [네이버 서치어드바이저 가이드](/blog/naver-search-advisor-guide)

## 아임웹 SEO — 무엇이 가능하고 무엇이 막혀 있나

**아임웹 SEO**는 코딩 없이 사이트를 만들 수 있는 편의성과, 코드 수준 제어가 막혀 있는 **아임웹 SEO 한계**가 공존합니다. 메타 태그·사이트맵·SSL·반응형은 기본 제공되지만, HTML 구조 직접 수정·SSR·세부 속도 최적화는 불가능합니다. 그래서 **아임웹 검색 노출**은 "주어진 SEO 설정을 100% 활용 + 콘텐츠 품질로 보완" 전략이 핵심입니다.
...
> SearchTune OS로 아임웹 사이트의 SEO·AEO·GEO 점수를 진단하고 개선 포인트를 확인하세요.`,
  },
  {
    ...
    title: "카페24 SEO 완벽 가이드 — 카페24 상품 페이지 SEO·쇼핑몰 SEO 진단",
    excerpt:
      "카페24 SEO 최적화는 어디서 시작할까? 카페24 상품 페이지 SEO·구조화 데이터·네이버 쇼핑 EP까지, 쇼핑몰 SEO 진단을 위한 실전 체크리스트를 SearchTune OS 기준으로 정리했습니다.",
    category: "가이드",
    author: "서치튠 블로거",
    date: "2026-06-05",
    thumbnail: "/placeholder.svg",
    ...
    content: `> **TL;DR** — **카페24 상품 페이지 SEO**는 \`Product 구조화 데이터 + 200자+ 고유 상품설명 + 이미지 ALT + 네이버 쇼핑 EP 연동\` 4종 세트가 핵심입니다. 한국 최대 이커머스 플랫폼답게 HTML/CSS 직접 편집이 가능해 자유도가 가장 높습니다.

관련: [아임웹 SEO 완벽 가이드](/blog/imweb-seo-guide) · [네이버 서치어드바이저 가이드](/blog/naver-search-advisor-guide) · [FAQ 스키마 작성 방법](/blog/faq-schema-aeo-boost)

## 카페24 SEO — 왜 자유도가 가장 높은가

**카페24 SEO**는 한국 노코드/이커머스 빌더 중 가장 자유도가 높습니다. 약 200만 개 쇼핑몰이 운영되는 한국 최대 이커머스 플랫폼이며, **HTML/CSS 직접 편집**, **커스텀 URL**, **JSON-LD 구조화 데이터 삽입**, **네이버 쇼핑 EP 연동**이 모두 가능합니다. 따라서 **카페24 상품 페이지 SEO**와 카테고리 SEO를 체계화하면, 단순 운영 대비 검색 매출을 크게 끌어올릴 수 있습니다. SearchTuneOS의 **쇼핑몰 SEO 진단**으로 현재 위치를 먼저 파악하세요.
...
> SearchTune OS로 카페24 쇼핑몰의 SEO·AEO·GEO 현황을 무료로 진단해보세요.`,
  ...
  {
    slug: "google-ai-search-official-guide-2026",
    title: "구글 공식 AI 검색 최적화 가이드 정리 (2026) — llms.txt·청킹은 정말 필요할까?",
    excerpt:
      "구글이 공개한 AI 검색 공식 가이드라인을 한국어로 정리했습니다. llms.txt, 콘텐츠 청킹, AI용 키워드 재작성이 정말 필요한지, People-first·E-E-A-T·Query Fan-out 시대에 무엇이 진짜 점수를 만드는지 서치튠OS 기준으로 풀어봅니다.",
    category: "SEO",
    author: "서치튠 블로거",
    date: "2026-06-02",
    thumbnail: "/placeholder.svg",
    ...
    readTime: "9분",
    faqs: [
      { question: "구글은 AI 검색을 위해 llms.txt를 따로 만들어야 한다고 하나요?", answer: "아니요. 구글 공식 가이드는 llms.txt나 AI 전용 마크업이 필요하지 않다고 명시합니다. 일반 HTML과 기존 SEO 신호로 충분하며, 서치튠OS도 llms.txt가 없다고 점수를 깎지 않습니다(있으면 가점)." },
      { question: "콘텐츠를 잘게 청킹(chunking)해야 AI가 잘 인용하나요?", answer: "구글은 'AI가 이해하기 위해 인위적으로 잘게 쪼갤 필요는 없다'고 안내합니다. 사람이 읽기 좋은 구조(H2/H3, 요약, 리스트)면 RAG·Query Fan-out에서도 잘 동작합니다." },
      { question: "AI 검색 시대에 가장 중요한 신호는 무엇인가요?", answer: "기존 SEO 신뢰 신호(HTTPS·저자·인용·업데이트)와 People-first·E-E-A-T(직접 경험, 1인칭 사례, 고유 데이터)입니다. 구글은 'AI 검색 = 기존 랭킹 + RAG + Query Fan-out'이라고 설명합니다." },
      { question: "AI용으로 키워드를 다시 욱여넣어도 되나요?", answer: "위험합니다. 구글은 AI 검색용 롱테일·키워드 재작성을 권장하지 않으며, 양산형 콘텐츠는 스팸 정책으로 필터링됩니다. 동의어 이해도 이미 충분합니다." },
      { question: "서치튠OS 점수 엔진은 이 가이드와 어떻게 정합되어 있나요?", answer: "엔진 프롬프트 안에 'GOOGLE_OFFICIAL_BASELINE' 블록을 두어, llms.txt·청킹·AI 재작성을 감점 사유에서 제외하고, E-E-A-T·비기성품(Non-commodity) 신호와 RAG 친화 신뢰 시그널의 가중치를 올렸습니다." },
    ],
    content: `> **TL;DR**
> 구글이 직접 공개한 AI 검색 최적화 가이드의 핵심은 "특별한 AI 전용 작업은 거의 필요 없다"입니다.
> llms.txt·청킹·AI용 키워드 재작성은 필수가 아니며, 진짜 중요한 건 People-first 콘텐츠, E-E-A-T, 그리고 기존 SEO 신뢰 신호입니다.
> 서치튠OS의 SEO·AEO·GEO 점수 엔진도 이 공식 가이드에 맞춰 정합되어 있습니다.

## 구글 공식 가이드, 뭐라고 했나

구글은 [AI 검색 최적화 가이드(공식 문서)](https://developers.google.com/search/docs/fundamentals/ai-optimization-guide?hl=ko)에서 AI 답변·AI Overviews·AI Mode를 한 줄로 정리합니다.

> **"AI 기능은 기존 구글 검색 랭킹 시스템 위에서 동작합니다."**

즉, AI 검색을 위해 별도의 마법 같은 신호가 따로 있는 게 아니라, 기존에 좋은 SEO 점수를 받던 페이지가 AI 답변에서도 인용되기 쉽다는 뜻입니다.

## 구글이 "필요 없다"고 말한 것들

공식 가이드와 후속 블로그(2025-05, *Succeeding in AI Search*)에서 구글은 다음을 **불필요**하다고 명시합니다.

| 흔히 떠도는 조언 | 구글 공식 입장 |
| --- | --- |
| llms.txt / AI 전용 마크업 작성 | 필요 없음. 일반 HTML로 충분 |
| 콘텐츠를 잘게 청킹해 LLM이 먹기 쉽게 자르기 | 필요 없음. 사람 가독성 우선 |
| AI용 키워드 재작성 / 롱테일 욱여넣기 | 권장하지 않음. 스팸으로 분류될 수 있음 |
| 인위적 브랜드 멘션 / 가짜 바이럴 | 필터링됨. 위험만 큼 |

서치튠OS도 이 입장을 그대로 반영해, **llms.txt가 없다는 이유로 SEO/AEO/GEO 점수를 깎지 않습니다.** 있으면 보너스만 부여합니다.

## 그럼 진짜 중요한 건 뭔가

### 1) RAG와 Query Fan-out

구글 AI 검색은 두 개의 핵심 메커니즘으로 동작합니다.

- **RAG (Retrieval-Augmented Generation)**: 기존 랭킹 시스템으로 신뢰 가능한 페이지를 먼저 찾고, 그걸 근거로 답을 생성합니다.
- **Query Fan-out**: 사용자의 한 질문을 여러 개의 연관 질문으로 펼쳐 동시에 검색합니다. 즉, **하나의 주제를 다층으로 다룬 글**이 더 자주 인용됩니다.

### 2) People-first / 비기성품(Non-commodity)

구글의 [유용한 콘텐츠 가이드](https://developers.google.com/search/docs/fundamentals/creating-helpful-content?hl=ko)는 "당신의 글이 검색엔진을 위해서가 아니라 사람을 위해 쓰였는가?"를 반복해서 묻습니다. 특히 AI 양산형 글이 넘치는 지금, 구글이 보상하는 건 **직접 경험·실측 데이터·고유한 관점**입니다.

### 3) E-E-A-T (경험·전문성·권위·신뢰)

- **저자 정보**가 있는가
- 운영하는 **조직/About 페이지**가 있는가
- 출처를 **인용**하는가
- **업데이트 일자**가 명확한가

이 네 가지는 RAG가 "이 페이지를 답변 근거로 써도 되는가"를 판단할 때 사실상 기본 통과 조건입니다.

## 그래서 서치튠OS는 어떻게 바뀌었나

엔진 프롬프트 안에 \`GOOGLE_OFFICIAL_BASELINE\` 블록을 만들고, 다음 6대 원칙을 **불변 룰**로 박아뒀습니다.

1. llms.txt·AI 마크업·청킹·AI 재작성 = **가점만, 감점 금지**
2. AI 검색의 근간은 **기존 SEO + RAG + Query Fan-out**
3. People-first / 비기성품 콘텐츠 우대 (1인칭·실측·고유 사례에 가점)
4. **E-E-A-T 명시 평가** (저자/조직/About 존재 여부 반영)
5. AEO 청킹·Q&A 강제 요건 완화 (FAQPage 없다고 priorityFix로 올리지 않음)
6. 모든 score 근거 끝에 **"구글 공식 가이드: ◯◯"** 한 줄을 붙여 출처 명시

자동 2주 주기 엔진 업데이트가 이 블록을 덮어쓰지 못하도록, 네이버 룰북과 동일한 보존 가드도 함께 적용해뒀습니다.

## 운영자가 오늘 당장 할 수 있는 것

- ❌ llms.txt 만들기에 시간 쓰지 않기
- ❌ AI용으로 키워드 다시 욱여넣지 않기
- ✅ **About / 저자 페이지** 정비 (이름·경력·연락처)
- ✅ 글마다 **1인칭 경험·실측 데이터·고유 사례** 한 단락 이상
- ✅ **robots.txt / sitemap.xml / 구조화 데이터** 기본기 점검
- ✅ 하나의 주제를 **여러 각도(정의·비교·사례·FAQ)** 로 다루기 → Query Fan-out 친화

## 마무리

AI 검색은 새로운 트릭이 아니라, **사람을 위해 정직하게 쓴 글에 신뢰 신호를 얹는 작업**입니다. 구글이 공식 문서로 이걸 다시 한 번 확인해줬고, 서치튠OS의 점수 엔진은 그 공식 가이드를 그대로 따르도록 정합되어 있습니다.

> 내 사이트가 구글 공식 가이드 기준에 얼마나 부합하는지, **서치튠OS에서 URL 하나로 무료 진단**해보세요.

**참고 자료**

- [Google Search Central — AI 검색 최적화 가이드(공식)](https://developers.google.com/search/docs/fundamentals/ai-optimization-guide?hl=ko)
- [Google Search Central — Creating helpful, reliable, people-first content](https://developers.google.com/search/docs/fundamentals/creating-helpful-content?hl=ko)
- [Google Search Central Blog — Succeeding in AI Search (2025-05)](https://developers.google.com/search/blog)`,
  },
];
