...
export const PURELEAF_DEMO: DemoBrandSeed = {
  ...
  brief: {
    ...
    titleVariants: [
      {
        label: "A · 비교/리스트형 (선택)",
        value: "민감성 피부 시카 세럼 추천 7선 — 2026년 비건 인증 기준 비교",
        angle: "구매 직전 사용자 타깃 · 숫자(7선)·연도(2026)로 클릭률↑",
      },
      {
        label: "B · 문제 해결형",
        value: "‘바르면 따가워요’ 민감성 피부도 안심하는 시카 세럼 고르는 법",
        angle: "고통 포인트 인용형 · AEO/Q&A 검색에 강함",
      },
      {
        label: "C · 권위 인증형",
        value: "피부과 전문의가 추천한 비건 시카 세럼 7가지 (병풀 함량 비교표)",
        angle: "GEO·신뢰도 강조 · AI Overview 인용 적합",
      },
    ],
    metaDescription:
    ...
    metaDescriptionVariants: [
      ...
      },
      {
        label: "B · 감성 후킹형 (148자)",
        value:
          "트러블 없이 매일 쓰는 시카 세럼이 궁금하다면? 민감성 피부 32명이 8주간 직접 테스트한 비건 인증 시카 세럼 7가지를 가격·자극도까지 비교했습니다.",
        angle: "후기·체험 강조 · 감성 클릭 유도",
      },
    ],
...
`,
  scores: {
    // 강점·약점 대비를 명확히: SEO(강점) > AEO(중간/강점) > GEO(약점)
    // 시연자가 "잘한 부분 → 보완 부분" 흐름을 자연스럽게 짚을 수 있도록 의도적 격차.
    seo: {
      score: 88,
      comment:
        "타깃 키워드 ‘시카 세럼 추천’이 H1·메타·H2·본문에 자연 분포. 비교표(7선)·내부 링크 4개로 구조 신호 강함.",
    },
    aeo: {
      score: 81,
      comment:
        "FAQ 5개가 Q→A 단답 구조로 정돈, 수치 근거(병풀 8%·재구매 87%) 명확 — ChatGPT·Perplexity 인용 적합.",
    },
    geo: {
      score: 64,
      comment:
        "권위 신호(SCI 논문·인증 비교)는 갖춰졌지만 저자 프로필·외부 출처 링크 부족. 보강 시 +15점 도달 가능.",
    },
  },
};
