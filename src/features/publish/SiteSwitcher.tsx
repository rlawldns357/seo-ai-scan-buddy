...
export default function SiteSwitcher() {
  ...
  return (
    <div className="px-2 pt-2 pb-1 relative">
      <button
        onClick={() => setOpen((v) => !v)}
        className="w-full flex items-center gap-2 px-2.5 py-2 rounded-lg border border-sidebar-border bg-sidebar-accent/40 hover:bg-sidebar-accent transition text-left"
