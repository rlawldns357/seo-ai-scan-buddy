...
export default function WorkspaceHeader() {
  ...
  return (
    <div className="relative overflow-hidden mb-6 rounded-3xl border border-border/60 bg-gradient-to-br from-primary/[0.04] via-card to-accent/[0.04] px-5 py-5 sm:px-6 sm:py-6">
      {/* 5% 브랜딩 글로우 (강도 낮춤) */}
      <div className="pointer-events-none absolute -top-20 -right-16 h-56 w-56 rounded-full bg-primary/[0.07] blur-3xl" aria-hidden />
      <div className="pointer-events-none absolute -bottom-20 -left-16 h-56 w-56 rounded-full bg-accent/[0.07] blur-3xl" aria-hidden />
