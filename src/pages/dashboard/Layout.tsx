...
export default function DashboardLayout() {
  ...
  // Guests on /dashboard root see the marketing landing without sidebar/header chrome.
  ...
  // All other dashboard routes (and authenticated /dashboard) require auth + show sidebar.
  return (
    <RequireAuth>
      <SidebarProvider>
        <div className="min-h-screen flex flex-col w-full bg-background">
