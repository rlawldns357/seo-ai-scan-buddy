  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content={`${site.title} 콘텐츠 허브 - SearchTune OS Auto Publish로 발행됨`} />
      ...
      <main className="container max-w-3xl py-12 px-4">
        <header className="mb-10">
          ...
          <p className="text-sm text-muted-foreground mt-2">SearchTune OS Auto Publish로 운영되는 콘텐츠 허브</p>
        </header>
