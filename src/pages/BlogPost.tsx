...
function getBrandThumbnail(slug: string, category: string, large = false) {
  ...
  // 2) 공유 브랜드 모듈로 자동 감지 (ChatGPT/Claude/Gemini/Perplexity/Wrtn/Google/Bing 등)
      ...
      <main className="container pt-10 pb-28 md:pt-16 md:pb-32">
        ...
        <article className="max-w-3xl mx-auto">
          ...
          {(post.slug.includes("ask-ai-models-comparison") || post.slug.includes("ask-ai-launch")) ? (
            <div className="mt-8 relative overflow-hidden rounded-2xl aspect-[2/1] md:aspect-[2.4/1] bg-card border border-border shadow-sm">
              {/* corner gradient accents */}
              <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full opacity-30 blur-3xl" style={{ background: "hsl(var(--accent))" }} />
              <div className="absolute -bottom-24 -left-16 w-72 h-72 rounded-full opacity-25 blur-3xl" style={{ background: "hsl(var(--primary))" }} />

              <div className="relative h-full w-full flex flex-col justify-center px-8 md:px-14 py-8">
                <div className="flex items-center gap-3">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] md:text-[11px] font-extrabold tracking-widest uppercase text-primary-foreground shadow-md"
                ...
                <div className="mt-4 h-1 w-20 rounded-full" style={{ background: "linear-gradient(90deg, hsl(var(--primary)), hsl(var(--accent)))" }} />
