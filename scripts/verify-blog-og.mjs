 ...
 * dist/blog/{slug}/index.html contains correct OG metadata and that canonical/og:url
 * point to the clean URL https://searchtuneos.com/blog/{slug}.
 *
...
function collectBlogFiles() {
  ...
  for (const entry of entries) {
    if (entry.isDirectory()) {
      ...
      files.push({ slug, label: `/blog/${slug}`, path: path.join(BLOG_DIR, slug, "index.html") });
    }
  }
